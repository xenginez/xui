...
std::shared_ptr<Gdiplus::Brush> gdi_implement::create_brush( const xui::filled & filled ) const
{
    ...
    case xui::filled::DENSE1:
        return std::make_shared<Gdiplus::HatchBrush>( Gdiplus::HatchStyle10Percent, Gdiplus::Color{ std::get<xui::hatch>( filled.colors ).fore_color.a, std::get<xui::hatch>( filled.colors ).fore_color.r, std::get<xui::hatch>( filled.colors ).fore_color.g, std::get<xui::hatch>( filled.colors ).fore_color.b }, Gdiplus::Color{ std::get<xui::hatch>( filled.colors ).back_color.a, std::get<xui::hatch>( filled.colors ).back_color.r, std::get<xui::hatch>( filled.colors ).back_color.g, std::get<xui::hatch>( filled.colors ).back_color.b } );
    case xui::filled::DENSE2:
        return std::make_shared<Gdiplus::HatchBrush>( Gdiplus::HatchStyle20Percent, Gdiplus::Color{ std::get<xui::hatch>( filled.colors ).fore_color.a, std::get<xui::hatch>( filled.colors ).fore_color.r, std::get<xui::hatch>( filled.colors ).fore_color.g, std::get<xui::hatch>( filled.colors ).fore_color.b }, Gdiplus::Color{ std::get<xui::hatch>( filled.colors ).back_color.a, std::get<xui::hatch>( filled.colors ).back_color.r, std::get<xui::hatch>( filled.colors ).back_color.g, std::get<xui::hatch>( filled.colors ).back_color.b } );
    case xui::filled::DENSE3:
        return std::make_shared<Gdiplus::HatchBrush>( Gdiplus::HatchStyle30Percent, Gdiplus::Color{ std::get<xui::hatch>( filled.colors ).fore_color.a, std::get<xui::hatch>( filled.colors ).fore_color.r, std::get<xui::hatch>( filled.colors ).fore_color.g, std::get<xui::hatch>( filled.colors ).fore_color.b }, Gdiplus::Color{ std::get<xui::hatch>( filled.colors ).back_color.a, std::get<xui::hatch>( filled.colors ).back_color.r, std::get<xui::hatch>( filled.colors ).back_color.g, std::get<xui::hatch>( filled.colors ).back_color.b } );
    case xui::filled::DENSE4:
        return std::make_shared<Gdiplus::HatchBrush>( Gdiplus::HatchStyle40Percent, Gdiplus::Color{ std::get<xui::hatch>( filled.colors ).fore_color.a, std::get<xui::hatch>( filled.colors ).fore_color.r, std::get<xui::hatch>( filled.colors ).fore_color.g, std::get<xui::hatch>( filled.colors ).fore_color.b }, Gdiplus::Color{ std::get<xui::hatch>( filled.colors ).back_color.a, std::get<xui::hatch>( filled.colors ).back_color.r, std::get<xui::hatch>( filled.colors ).back_color.g, std::get<xui::hatch>( filled.colors ).back_color.b } );
    case xui::filled::DENSE5:
        return std::make_shared<Gdiplus::HatchBrush>( Gdiplus::HatchStyle50Percent, Gdiplus::Color{ std::get<xui::hatch>( filled.colors ).fore_color.a, std::get<xui::hatch>( filled.colors ).fore_color.r, std::get<xui::hatch>( filled.colors ).fore_color.g, std::get<xui::hatch>( filled.colors ).fore_color.b }, Gdiplus::Color{ std::get<xui::hatch>( filled.colors ).back_color.a, std::get<xui::hatch>( filled.colors ).back_color.r, std::get<xui::hatch>( filled.colors ).back_color.g, std::get<xui::hatch>( filled.colors ).back_color.b } );
    case xui::filled::DENSE6:
        return std::make_shared<Gdiplus::HatchBrush>( Gdiplus::HatchStyle60Percent, Gdiplus::Color{ std::get<xui::hatch>( filled.colors ).fore_color.a, std::get<xui::hatch>( filled.colors ).fore_color.r, std::get<xui::hatch>( filled.colors ).fore_color.g, std::get<xui::hatch>( filled.colors ).fore_color.b }, Gdiplus::Color{ std::get<xui::hatch>( filled.colors ).back_color.a, std::get<xui::hatch>( filled.colors ).back_color.r, std::get<xui::hatch>( filled.colors ).back_color.g, std::get<xui::hatch>( filled.colors ).back_color.b } );
    case xui::filled::DENSE7:
        return std::make_shared<Gdiplus::HatchBrush>( Gdiplus::HatchStyle70Percent, Gdiplus::Color{ std::get<xui::hatch>( filled.colors ).fore_color.a, std::get<xui::hatch>( filled.colors ).fore_color.r, std::get<xui::hatch>( filled.colors ).fore_color.g, std::get<xui::hatch>( filled.colors ).fore_color.b }, Gdiplus::Color{ std::get<xui::hatch>( filled.colors ).back_color.a, std::get<xui::hatch>( filled.colors ).back_color.r, std::get<xui::hatch>( filled.colors ).back_color.g, std::get<xui::hatch>( filled.colors ).back_color.b } );
    case xui::filled::HORIZONTAL:
        return std::make_shared<Gdiplus::HatchBrush>( Gdiplus::HatchStyleHorizontal, Gdiplus::Color{ std::get<xui::hatch>( filled.colors ).fore_color.a, std::get<xui::hatch>( filled.colors ).fore_color.r, std::get<xui::hatch>( filled.colors ).fore_color.g, std::get<xui::hatch>( filled.colors ).fore_color.b }, Gdiplus::Color{ std::get<xui::hatch>( filled.colors ).back_color.a, std::get<xui::hatch>( filled.colors ).back_color.r, std::get<xui::hatch>( filled.colors ).back_color.g, std::get<xui::hatch>( filled.colors ).back_color.b } );
    case xui::filled::VERTICAL:
        return std::make_shared<Gdiplus::HatchBrush>( Gdiplus::HatchStyleVertical, Gdiplus::Color{ std::get<xui::hatch>( filled.colors ).fore_color.a, std::get<xui::hatch>( filled.colors ).fore_color.r, std::get<xui::hatch>( filled.colors ).fore_color.g, std::get<xui::hatch>( filled.colors ).fore_color.b }, Gdiplus::Color{ std::get<xui::hatch>( filled.colors ).back_color.a, std::get<xui::hatch>( filled.colors ).back_color.r, std::get<xui::hatch>( filled.colors ).back_color.g, std::get<xui::hatch>( filled.colors ).back_color.b } );
    case xui::filled::CROSS:
        return std::make_shared<Gdiplus::HatchBrush>( Gdiplus::HatchStyleCross, Gdiplus::Color{ std::get<xui::hatch>( filled.colors ).fore_color.a, std::get<xui::hatch>( filled.colors ).fore_color.r, std::get<xui::hatch>( filled.colors ).fore_color.g, std::get<xui::hatch>( filled.colors ).fore_color.b }, Gdiplus::Color{ std::get<xui::hatch>( filled.colors ).back_color.a, std::get<xui::hatch>( filled.colors ).back_color.r, std::get<xui::hatch>( filled.colors ).back_color.g, std::get<xui::hatch>( filled.colors ).back_color.b } );
    case xui::filled::FORWARD:
        return std::make_shared<Gdiplus::HatchBrush>( Gdiplus::HatchStyleForwardDiagonal, Gdiplus::Color{ std::get<xui::hatch>( filled.colors ).fore_color.a, std::get<xui::hatch>( filled.colors ).fore_color.r, std::get<xui::hatch>( filled.colors ).fore_color.g, std::get<xui::hatch>( filled.colors ).fore_color.b }, Gdiplus::Color{ std::get<xui::hatch>( filled.colors ).back_color.a, std::get<xui::hatch>( filled.colors ).back_color.r, std::get<xui::hatch>( filled.colors ).back_color.g, std::get<xui::hatch>( filled.colors ).back_color.b } );
    case xui::filled::BACKWARD:
        return std::make_shared<Gdiplus::HatchBrush>( Gdiplus::HatchStyleBackwardDiagonal, Gdiplus::Color{ std::get<xui::hatch>( filled.colors ).fore_color.a, std::get<xui::hatch>( filled.colors ).fore_color.r, std::get<xui::hatch>( filled.colors ).fore_color.g, std::get<xui::hatch>( filled.colors ).fore_color.b }, Gdiplus::Color{ std::get<xui::hatch>( filled.colors ).back_color.a, std::get<xui::hatch>( filled.colors ).back_color.r, std::get<xui::hatch>( filled.colors ).back_color.g, std::get<xui::hatch>( filled.colors ).back_color.b } );
    case xui::filled::DIAGCROSS:
        return std::make_shared<Gdiplus::HatchBrush>( Gdiplus::HatchStyleDiagonalCross, Gdiplus::Color{ std::get<xui::hatch>( filled.colors ).fore_color.a, std::get<xui::hatch>( filled.colors ).fore_color.r, std::get<xui::hatch>( filled.colors ).fore_color.g, std::get<xui::hatch>( filled.colors ).fore_color.b }, Gdiplus::Color{ std::get<xui::hatch>( filled.colors ).back_color.a, std::get<xui::hatch>( filled.colors ).back_color.r, std::get<xui::hatch>( filled.colors ).back_color.g, std::get<xui::hatch>( filled.colors ).back_color.b } );
    case xui::filled::LINEAR:
        return std::make_shared<Gdiplus::LinearGradientBrush>( Gdiplus::PointF{ std::get<xui::linear>( filled.colors ).p1.x,std::get<xui::linear>( filled.colors ).p1.y }, Gdiplus::PointF{ std::get<xui::linear>( filled.colors ).p2.x,std::get<xui::linear>( filled.colors ).p2.y }, Gdiplus::Color{ std::get<xui::linear>( filled.colors ).c1.a, std::get<xui::linear>( filled.colors ).c1.r, std::get<xui::linear>( filled.colors ).c1.g, std::get<xui::linear>( filled.colors ).c1.b }, Gdiplus::Color{ std::get<xui::linear>( filled.colors ).c2.a, std::get<xui::linear>( filled.colors ).c2.r, std::get<xui::linear>( filled.colors ).c2.g, std::get<xui::linear>( filled.colors ).c2.b } );
